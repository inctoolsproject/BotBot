...
creator = ["ubb1e6a44192983c5d5770a7dce6ff36c"]
Owner = ["ubb1e6a44192983c5d5770a7dce6ff36c"]
...
responsename = "(★^O^★) Present"
responsename2 = "＼（＠￣∇￣＠）／ yay!"
responsename3 = "｡:.ﾟヽ(´∀`｡)ﾉﾟ.:. im here" 
responsename4 = "( ͡◉ ͜ʖ ͡◉)uhhmmm"
responsename5 = "( ‾ ʖ̫ ‾)present?"
#==============================================================================#
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "Hєllσ thαnk чσu fσr αddíng mє αs α fríєnd :D \n Mention me if you need something :D \nヾ(｡･ω･｡)".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
        ...
        if op.type == 17:
            ...
            nadya.sendMessage(c)
            nadya.sendText(op.param1,"Hello " + nadya.getContact(op.param2).displayName + "\nƜЄԼƇƠMЄ Ƨƛ ƁƖƧƊƛƘ ƛƬƠ ƝƖ ☞ " + str(ginfo.name) + " ☜" + "\n  ＼(*T▽T*)／\n  \n “ヽ(´▽｀)ノ” \n ＥＮＪＯＹ ＹＯＵＲ ＳＴＡＹ ＨＥＲＥ ＢＡＷＡＬ ＡＷＡＹ ＫＩＴＡ ＴＡＮＡＮ ＭＡＧ ＳＩＮＡＢＴＡＮＡＹ  ＬＩＰＡＹ ＬＩＰＡＹ ＴＡ ＤＥＲＥ ＢＩＳＤＡＫ ＴＡＭＢＡＹＡＮ \n---ＮＯ ＡＤＭＩＮ ＨＥＲＥ--- \n °˖✧◝(⁰▿⁰)◜✧˖° °˖ ✧◝(⁰▿⁰)◜✧˖°")
...
#==============================================================================#
                    ...
                    if msg._from in Owner:    
                        nadya.sendMessage(to, "Please Wait...")
                        time.sleep(5)
                        nadya.sendMessage(to, "Restart Success")
                        restartBot()
                    ...
                    if msg._from in Owner:
                        ...
                        nadya.sendMessage(to, "Bot is running for {}".format(str(runtime)))
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        if Owner == []:
                            ...
                            nadya.sendMessage(msg.to,"Please wait...")
                            mc = "╔═══════════════\n╠ MANG KANOR═✪〘 Owner List 〙✪═══\n"
                            for mi_d in admin:
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        ...
                        nadya.sendMessage(to, "Successfully activated Auto Add")
                elif text.lower() == 'autoadd off':
                    if msg._from in Owner:
                        settings["autoAdd"] = False
                        nadya.sendMessage(to, "Successfully disable Auto Add")
                elif text.lower() == 'autojoin on':
                    if msg._from in Owner:    
                        settings["autoJoin"] = True
                        nadya.sendMessage(to, "Successfully activated Auto Join")
                elif text.lower() == 'autojoin off':
                    if msg._from in Owner:    
                        settings["autoJoin"] = False
                        nadya.sendMessage(to, "Successfully disable Auto Join")
                elif text.lower() == 'autoleave on':
                    if msg._from in Owner:
                        settings["autoLeave"] = True
                        nadya.sendMessage(to, "Successfully activated Auto Leave")
                elif text.lower() == 'autoleave off':
                    if msg._from in Owner:
                        settings["autoLeave"] = False
                        nadya.sendMessage(to, "Successfully disable Auto Leave")
                elif text.lower() == 'autoread on':
                    if msg._from in Owner:
                        settings["autoRead"] = True
                        nadya.sendMessage(to, "Successfully activated Auto Read")
                elif text.lower() == 'autoread off':
                    if msg._from in Owner:
                        settings["autoRead"] = False
                        nadya.sendMessage(to, "Successfully disable Auto Read")
                elif text.lower() == 'checksticker on':
                    if msg._from in Owner:
                        settings["checkSticker"] = True
                        nadya.sendMessage(to, "Successfully activated Check Details Sticker")
                elif text.lower() == 'checksticker off':
                    if msg._from in Owner:
                        settings["checkSticker"] = False
                        nadya.sendMessage(to, "Successfully disable Check Details Sticker")
                elif text.lower() == 'detectmention on':
                    if msg._from in Owner:
                        settings["datectMention"] = True
                        nadya.sendMessage(to, "Successfully activated Detect Mention")
                elif text.lower() == 'detectmention off':
                    if msg._from in Owner:
                        settings["datectMention"] = False
                        nadya.sendMessage(to, "Successfully disable Detect Mention")
                elif text.lower() == 'autojoinlink on':
                    if msg._from in Owner:
                        settings["autoJoinTicket"] = True
                        nadya.sendMessage(to, "Successfully activated Auto Join Link")
                elif text.lower() == 'autojoinlink off':
                    if msg._from in Owner:
                        settings["autoJoinTicket"] = False
                        nadya.sendMessage(to, "Successfully disable Auto Join Link")                    
#==============================================================================#
                  ...
                  if msg._from in Owner:    
                    try:
                        ...
                        nadya.sendMessage(msg.to, "Successfully restore profile wait a while until profile change")
                    except:
                        nadya.sendMessage(msg.to, "Failed restore profile")
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"Target added!")
                            break
                        except:
                            nadya.sendMessage(msg.to,"Added Target Fail !")
                            break
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"Target Deleted!")
                            break
                        except:
                            nadya.sendMessage(msg.to,"Deleted Target Fail !")
                            break
                    ...
                    if settings["mimic"]["target"] == {}:
                        nadya.sendMessage(msg.to,"Theres no Target")
                    else:
                        mc = "╔══[ Mimic List ]"
...
#==============================================================================#
                    ...
                    if msg._from in Owner:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            nadya.sendMessage(to, "The qr group is not open please open it first with the command {}openqr".format(str(settings["keyCommand"])))
                elif text.lower() == 'groupticket on':
                        if msg._from in Owner:
                            if msg.toType == 2:
                                group = nadya.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            nadya.sendMessage(to, "The qr group is already open")
                        else:
                            group.preventedJoinByTicket = False
                            nadya.updateGroup(group)
                            nadya.sendMessage(to, "Successfully opened the qr group")
                elif text.lower() == 'groupticket off':
                        if msg._from in Owner:
                            if msg.toType == 2:
                                group = nadya.getGroup(to)
                            if group.preventedJoinByTicket == True:
                                nadya.sendMessage(to, "The qr group is already closed")
                            else:
                                group.preventedJoinByTicket = True
                                nadya.updateGroup(group)
                                nadya.sendMessage(to, "Successfully closed the group qr")
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        settings["blacklist"] = {}
                        nadya.sendMessage(msg.to,"Blacklist Cleared")
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        if settings["blacklist"] == {}:
                            nadya.sendMessage(msg.to,"No Banlist")
                        else:
                            nadya.sendMessage(msg.to,"List Banlist")
                            num=1
                            msgs="══════════List Blacklist═════════"
...
#==============================================================================#          
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        nadya.sendMessage(msg.to, "Lurking is not enabled on reset?")
...
#                        ginfo = ki3.getGroup(op.param1)
                    ...
                    if op.param2 in admin:
                        ...
                        random.choice(KAC).sendText(op.param1,"Comeback bro...!")
                        ...
                        for mention in mentionees:
                            if nadyaMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    nadya.sendMessage(to, "i ddnt take off")
