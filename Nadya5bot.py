...
Owner = ["u3d8eac1d56155ead1762430efc3ccec4","u2a923e8837ee77316a2a205007938361"]
admin = ["u3d8eac1d56155ead1762430efc3ccec4","u2a923e8837ee77316a2a205007938361"]
...
responsename = "( ͡° ͜ʖ ͡°)im here bro( ͡° ͜ʖ ͡°)"
responsename2 = "( ͡☉ ͜ʖ ͡☉)bantay ako( ͡☉ ͜ʖ ͡☉)"
responsename3 = "(͠≖ ͜ʖ͠≖)sup"
responsename4 = "( ͡◉ ͜ʖ ͡◉)nara ko"
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "Hello thanks for adding me as a friend :D".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
...
#==============================================================================#   
                    ...
                    if msg._from in Owner:
                        ...
                        ret_ += "\n╠ Zodiac : {}".format(str(data["data"]["zodiak"]))
                        ret_ += "\n╚══[ Success ]"
                        nadya.sendMessage(to, str(ret_))
                    ...
                    with requests.session() as web:
                        ...
                        try:
                            ...
                            ret_ += "\n╠ Followed : {}".format(format_number(data["user"]["follows"]["count"]))
